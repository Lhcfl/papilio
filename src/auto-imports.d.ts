...
declare global {
  ...
  const useBlockAction: typeof import('./hooks/user-action')['useBlockAction']
  ...
  const useFollowAction: typeof import('./hooks/user-action')['useFollowAction']
  ...
  const useMuteAction: typeof import('./hooks/user-action')['useMuteAction']
  ...
  const useUnblockAction: typeof import('./hooks/user-action')['useUnblockAction']
  const useUndoReactNoteAction: typeof import('./hooks/note-actions')['useUndoReactNoteAction']
  const useUnfollowAction: typeof import('./hooks/user-action')['useUnfollowAction']
  const useUnmuteAction: typeof import('./hooks/user-action')['useUnmuteAction']
  const useUnrenoteAction: typeof import('./hooks/note-actions')['useUnrenoteAction']
  const useUserQuery: typeof import('./hooks/use-user')['useUserQuery']
